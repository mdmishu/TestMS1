package DynamicProgrammingStringsArray.LongestPalindromicSubString;

import java.util.Arrays;

//O(n^2) solution with DP.... becuase
...
//        }
        ...
        for(int k=3; k <= n; k++){
            // Fix the starting index k is the current length of the strings
